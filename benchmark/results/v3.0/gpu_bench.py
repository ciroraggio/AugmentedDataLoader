...
# no debug
def gpu_bench_no_debug_0_transf(dataset, augmentation_transforms, batch_size, subset_len):
    bench_no_debug_0_trans_prof.enable()
    augmented_data_loader = AugmentedDataLoader(dataset, augmentation_transforms, batch_size, subset_len, shuffle_mode="full", transformation_device="cuda:0", return_on_device="cuda:0")
    for img_batch, seg_batch in augmented_data_loader:
        continue
    bench_no_debug_0_trans_prof.disable()

def gpu_bench_no_debug_5_transf(dataset, augmentation_transforms, batch_size, subset_len):
...
def gpu_bench_no_debug_10_transf(dataset, augmentation_transforms, batch_size, subset_len):
...
# with debug
def gpu_bench_w_debug_0_transf(dataset, augmentation_transforms, batch_size, subset_len):
...
def gpu_bench_w_debug_5_transf(dataset, augmentation_transforms, batch_size, subset_len):
...
def gpu_bench_w_debug_10_transf(dataset, augmentation_transforms, batch_size, subset_len):
...
if __name__ == '__main__':
    ...
    five_trans_time_no_debug = timeit.timeit(stmt='gpu_bench_no_debug_5_transf(dataset, augmentation_transforms_5, batch_size, subset_len)', globals=globals(), number=time_iteration)
    ...
    ten_trans_time_no_debug = timeit.timeit(stmt='gpu_bench_no_debug_10_transf(dataset, augmentation_transforms_10, batch_size, subset_len)', globals=globals(), number=time_iteration)
    ...
    five_trans_time_debug = timeit.timeit(stmt='gpu_bench_w_debug_5_transf(dataset, augmentation_transforms_5, batch_size, subset_len)', globals=globals(), number=time_iteration)
    ...
    ten_trans_time_debug = timeit.timeit(stmt='gpu_bench_w_debug_10_transf(dataset, augmentation_transforms_10, batch_size, subset_len)', globals=globals(), number=time_iteration)
